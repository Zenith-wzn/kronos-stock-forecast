#!/usr/bin/env python
"""Prepare the locked CSI300 panel for the independent continual-learning ABC run.
...
window: 2026-05-27 through 2026-08-05, matching the latest strict ABCD recent-50 evaluation (90/10 windows).
"""
...
def main() -> None:
    ...
    p.add_argument("--train-end", default="2023-12-15")
    p.add_argument("--val-start", default="2024-01-02")
    p.add_argument("--val-end", default="2024-06-14")
    a = p.parse_args()
